...
rays_edmund = optical_system_edmunds_inverted.propagate_ray(ray_0, propagate_with_first_surface_first=True)

ax = optical_system_edmunds_inverted.plot()
