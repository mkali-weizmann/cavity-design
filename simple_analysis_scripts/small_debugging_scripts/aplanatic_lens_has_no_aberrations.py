...
surface_1 = SphericalRefractiveSurface(radius=np.abs(R_1), outwards_normal=RIGHT, center=first_surface_center, n_1=1.0,
                                       n_2=n, curvature_sign=CurvatureSigns.concave, name="concave side",
                                       diameter=diameter)
surface_2 = SphericalRefractiveSurface(radius=np.abs(R_2), outwards_normal=RIGHT,
