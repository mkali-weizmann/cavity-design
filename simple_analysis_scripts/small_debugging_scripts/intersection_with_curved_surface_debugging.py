...
general_mirror = SphericalMirror(radius=5e-3, outwards_normal=np.array([-1, 0, 0]), origin=np.array([0, 0, 0]))
right_mirror = SphericalMirror(radius=5e-3, outwards_normal=np.array([1, 0, 0]), origin=np.array([0, 0, 0]))
