...
D_ABCD_original_reflection = [cavity.arms[i].ABCD_matrix_surface_1[2:, 2:] for i in range(len(cavity.arms))]
D_ABCD_perturbed_reflection = [cavity_perturbed.arms[i].ABCD_matrix_surface_1[2:, 2:] for i in range(len(cavity_perturbed.arms))]
