...
surface_1 = SphericalRefractiveSurface(radius=5e-3, outwards_normal=np.array([1, 0, 0]),
...
surface_2 = SphericalRefractiveSurface(radius=5e-3, outwards_normal=np.array([1, 0, 0]),
