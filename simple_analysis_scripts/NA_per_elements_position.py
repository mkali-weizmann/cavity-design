...
params = [
          ...
          OpticalSurfaceParams(name='spherical - left'            ,surface_type='curved_refractive_surface'      , x=5.0762e-02              , y=0                       , z=0                       , theta=0                       , phi=1e+00 * np.pi           , radius=2.542632688301439e-01   , curvature_sign=CurvatureSigns.convex, T_c=np.nan                  , n_inside_or_after=1.51e+00                , n_outside_or_before=1e+00                   , diameter=6.3e-03                 , material_properties=MaterialProperties(refractive_index=None                    , alpha_expansion=None                    , beta_surface_absorption=None                    , kappa_conductivity=None                    , dn_dT=None                    , nu_poisson_ratio=None                    , alpha_volume_absorption=None                    , intensity_reflectivity=None                    , intensity_transmittance=None                    , temperature=np.nan                  ), polynomial_coefficients=None),
          OpticalSurfaceParams(name='spherical - right'            ,surface_type='curved_refractive_surface'      , x=5.4472e-02              , y=0                       , z=0                       , theta=0                       , phi=0                       , radius=2.542632688301439e-01   , curvature_sign=CurvatureSigns.concave, T_c=np.nan                  , n_inside_or_after=1e+00                   , n_outside_or_before=1.51e+00                , diameter=6.3e-03                 , material_properties=MaterialProperties(refractive_index=None                    , alpha_expansion=None                    , beta_surface_absorption=None                    , kappa_conductivity=None                    , dn_dT=None                    , nu_poisson_ratio=None                    , alpha_volume_absorption=None                    , intensity_reflectivity=None                    , intensity_transmittance=None                    , temperature=np.nan                  ), polynomial_coefficients=None)],
...
for i, short_arm_length in enumerate(short_arm_lengths):
    ...
    params[1][1].x = params[1][0].x + T_c_eksma
...
# # %% 2d map:
# fig, ax = plt.subplots(figsize=(10, 6))
# for long_arm_length in [20e-2, 25e-2, 30e-2, 35e-2, 40e-2]:  #
...
#             focus_to_lens = cavity.surfaces[3].center[0] - cavity.surfaces[2].center[0] - cavity.surfaces[3].radius
#             flag=True
#
