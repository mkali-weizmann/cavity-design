...
cavity = mirror_lens_mirror_cavity_generator(NA_left=NA_left, waist_to_lens=waist_to_lens, h=h, R_left=R_left,
                                             ...
                                             waist_to_left_mirror=5e-3, lambda_0_laser=LAMBDA_0_LASER,
...
overlaps_series = cavity_decomposed.generate_overlap_series(shifts=2 * np.abs(tolerance_matrix[:, :]), shift_numel=100,
