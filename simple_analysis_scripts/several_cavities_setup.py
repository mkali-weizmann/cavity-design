...
mirror_1 = SphericalMirror(radius=r_1, outwards_normal=outwards_normal_1, center=center_1)
mirror_2 = SphericalMirror(radius=r_2, outwards_normal=outwards_normal_2, center=center_2)
mirror_3 = SphericalMirror(radius=r_3, outwards_normal=outwards_normal_3, center=center_3)
cavity_checkmark = Cavity(elements=[mirror_1, mirror_2, mirror_3], standing_wave=True, lambda_0_laser=lambda_0_laser,
                          set_central_line=True, set_mode_parameters=True)
