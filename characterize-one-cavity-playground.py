...
params = [
          ...
          OpticalSurfaceParams(name='Lens_left'              ,surface_type='curved_refractive_surface'      , x=4.930700511195863e-03   , y=0                       , z=0                       , theta=0                       , phi=1e+00 * np.pi           , radius=2.422e-02               , curvature_sign=CurvatureSigns.convex, T_c=np.nan                  , n_inside_or_after=1.76e+00                , n_outside_or_before=1e+00                   , diameter=None                    , material_properties=MaterialProperties(refractive_index=1.76e+00                , alpha_expansion=5.5e-06                 , beta_surface_absorption=1e-06                   , kappa_conductivity=4.606e+01               , dn_dT=1.17e-05                , nu_poisson_ratio=3e-01                   , alpha_volume_absorption=1e-02                   , intensity_reflectivity=1e-04                   , intensity_transmittance=9.99899e-01             , temperature=np.nan                  ), polynomial_coefficients=None),
          OpticalSurfaceParams(name='Lens_right'             ,surface_type='curved_refractive_surface'      , x=7.844498052182406e-03   , y=0                       , z=0                       , theta=0                       , phi=0                       , radius=5.488e-03               , curvature_sign=CurvatureSigns.concave, T_c=np.nan                  , n_inside_or_after=1e+00                   , n_outside_or_before=1.76e+00                , diameter=None                    , material_properties=MaterialProperties(refractive_index=1.76e+00                , alpha_expansion=5.5e-06                 , beta_surface_absorption=1e-06                   , kappa_conductivity=4.606e+01               , dn_dT=1.17e-05                , nu_poisson_ratio=3e-01                   , alpha_volume_absorption=1e-02                   , intensity_reflectivity=1e-04                   , intensity_transmittance=9.99899e-01             , temperature=np.nan                  ), polynomial_coefficients=None)],
