...
I_analytic_matrices = gaussians_overlap_integral_matrices(A_1, A_2, b_1, b_2, c_1, c_2)
...
N_1_matrices = np.exp(gaussian_norm_matrices_log(A_1, b_1, c_1)**2)
...
N_2_matrices = np.exp(gaussian_norm_matrices_log(A_2, b_2, c_2)**2)
...
exponent_1_integral_matrices = np.exp(gaussian_integral_2d_matrices_log(A_1, b_1, c_1))
...
exponent_2_integral_matrices = np.exp(gaussian_integral_2d_matrices_log(A_2, b_2, c_2))
