...
x_lens = -26e-3
params_actual_lens = [
    OpticalElementParams(name='Small Mirror', surface_type='curved_mirror', x=x_1, y=0, z=0, theta=0, phi=0, r_1=24e-03,
    ...
    OpticalElementParams(name='Lens', surface_type='thick_lens', x=x_lens, y=0, z=0, theta=0, phi=-1e+00 * np.pi,
                         r_1=10000, r_2=13.1e-3, curvature_sign=CurvatureSigns.concave, T_c=11.7e-03,
                         n_inside_or_after=1.51e+00, n_outside_or_before=1e+00,
                         material_properties=PHYSICAL_SIZES_DICT['thermal_properties_bk7']),
    OpticalElementParams(name='Big Mirror', surface_type='curved_mirror', x=x_2, y=0, z=0, theta=0, phi=-1e+00 * np.pi,
...
DF_over_FSR_example = -0.0253522549145818
