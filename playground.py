...
dxi_dy2_n_surface = (P / k_l) * beta * dn_dT * w_l_1 ** -2 * 2
dxi_dy2_n_vol_1_radius_term = (P / k_l) * alpha_vol * dn_dT / R_lens * 2
dxi_dy2_n_vol_1_profile_term = (P / k_l) * alpha_vol * dn_dT * (w_half_lens / w_l_1 ** 2) * 2
dxi_dy2_curvature = (P / k_l) * n_lens * alpha_l * beta * c_nu_l * w_l_1 ** -2 * 2
