...
ax[0, 0].set_title("Heated Cavity")
plt.grid()
if auto_set_x:
...
#                             power=power)
# unheated_cavity = cavity.thermal_transformation()
# cavity.plot(axis_span=x_span, camera_center=camera_center, ax=ax[0, 1])
# ax[0, 1].set_title("Heated Cavity")
# plt.grid()
# if auto_set_x:
#     cavity_length = mirror_1.center[0] - mirror_3.center[0]
#     ax[0, 1].set_xlim(mirror_3.center[0] - 0.01 * cavity_length, mirror_1.center[0] + 0.01 * cavity_length)
# if auto_set_y:
#     y_lim = maximal_lens_height(R, w) * 1.1
# else:
#     y_lim = y_span
